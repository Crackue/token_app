...
def get_value(update: Update, context: CallbackContext):
    ...
    try:
        ...
        response = requests.post(url_constants.ether_erc20_approve_endpoint, data=obj, cookies=cookies)
    except KeyError:
        response = requests.post(url_constants.ether_erc20_approve_endpoint, data=obj)
